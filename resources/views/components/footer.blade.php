    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex space-x-6 mb-4 md:mb-0">
                <a href="#about" class="transition-colors duration-200" onmouseover="this.style.color='var(--color-light-blue)'" onmouseout="this.style.color=''">About</a>
                <a href="#projects" class="transition-colors duration-200" onmouseover="this.style.color='var(--color-light-blue)'" onmouseout="this.style.color=''">Projects</a>
                <a href="#contact" class="transition-colors duration-200" onmouseover="this.style.color='var(--color-light-blue)'" onmouseout="this.style.color=''">Contact</a>
            </div>

            <!-- Social Links -->
            <div class="flex space-x-4">
                <a href="https://github.com/yourusername" target="_blank" class="transition-colors duration-200" onmouseover="this.style.color='var(--color-light-blue)'" onmouseout="this.style.color=''">
                ...
                <a href="https://linkedin.com/in/yourusername" target="_blank" class="transition-colors duration-200" onmouseover="this.style.color='var(--color-light-blue)'" onmouseout="this.style.color=''">
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
