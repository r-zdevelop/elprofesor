...
<div class="px-4 py-6 sm:px-0">
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 mb-8">
        <div class="overflow-hidden shadow rounded-lg bg-accent">
            <div class="p-5">
    ...
    <!-- Quick Actions -->
    <div class="shadow rounded-lg p-6 mb-8 bg-accent">
        ...
        <div class="flex flex-wrap gap-4">
            <a href="{{ route('admin.posts.create') }}"
               ...
               class="bg-secondary hover:bg-dark">
                Create New Post
            </a>
    ...
    <div class="shadow rounded-lg p-6 mb-8 bg-accent">
        ...
        <div class="mt-4">
            <a href="{{ route('admin.posts.index') }}" class="text-sm font-medium text-secondary hover:text-dark transition-colors duration-200">
                View all posts →
            </a>
        </div>
    </div>
    ...
    <!-- Recent Projects -->
    <div class="shadow rounded-lg p-6 bg-accent">
        ...
        <div class="mt-4">
            <a href="{{ route('admin.projects.index') }}" class="text-sm font-medium text-secondary hover:text-dark transition-colors duration-200">
                View all projects →
            </a>
        </div>
    </div>
