...
<div class="px-4 py-6 sm:px-0">
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <form action="{{ route('admin.posts.update', $post) }}" method="POST" class="px-4 py-5 sm:p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6">
                    ...
                    <textarea name="excerpt"
                              id="excerpt"
                              rows="3"
                              class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('excerpt') border-red-500 @enderror">{{ old('excerpt', $post->excerpt) }}</textarea>
                    @error('excerpt')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-6">
                    ...
                    <textarea name="content"
                              ...
                              rows="10"
                              required
                              class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('content') border-red-500 @enderror">{{ old('content', $post->content) }}</textarea>
                    @error('content')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
