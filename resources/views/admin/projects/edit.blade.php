...
<div class="px-4 py-6 sm:px-0">
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <form action="{{ route('admin.projects.update', $project) }}" method="POST" class="px-4 py-5 sm:p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="type" id="type" required value="{{ old('type', $project->type) }}"
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="project_duration" id="project_duration" value="{{ old('project_duration', $project->project_duration) }}"
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="featured_image" id="featured_image" value="{{ old('featured_image', $project->featured_image) }}"
                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                ...
                <div class="col-span-6">
                    ...
                    <textarea name="description" id="description" rows="5" required
                              class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('description') border-red-500 @enderror">{{ old('description', $project->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-6">
                    ...
                    <textarea name="course_description" id="course_description" rows="3"
                              class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('course_description', $project->course_description) }}</textarea>
                </div>
